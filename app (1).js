...
$("improveBtn").onclick=()=>{const API_URL = "https://portfolio-website-rj9f.onrender.com";
const $ = id => document.getElementById(id);
const fields = ["name","role","location","email","photo","about","skills","degree","college","year","score","projectName","projectDesc","experience","linkedin","github"];
...
headers: {  
  ...
  body: JSON.stringify({  
    prompt:  
      "Improve the following About section for a professional portfolio. " +  
